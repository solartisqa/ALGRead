...
public class ConditionReading {
		...
		try { // may occur math error
			...
			for (int i = 0; i < numberOfElements; i++) {
				...
				if (s.equals("+") || s.equals("-") || s.equals("x") || s.equals("/") || s.equals("^") || // when an operator is found
						s.equals("sqrt") || s.equals("(") || s.equals(")") || s.equals("P") || s.equals("C")
						|| s.equals("mod") || s.equals("log") || s.equals("ln") || s.equals("fact") || s.equals("sin")
						|| s.equals("sinh") || s.equals("asin") || s.equals("cbrt") || s.equals("cos")
						|| s.equals("cosh") || s.equals("acos") || s.equals("cube") || s.equals("tan")
						|| s.equals("tanh") || s.equals("atan") || s.equals("sqre")) {
				...
				/*
				 * ///test print System.out.println(s+" "+o); /
				 **/
			}
	...
	private int operatorPrecedence(String str) {
		...
		if (str.equals("+"))
			...
			i = 7;
		else if (str.equals("P") || str.equals("C"))
			i = 8;
		else
			i = 9;
	...
	public static void main(String[] args) {
		System.out.println(new ConditionReading().infixEvaluation("10 + ( 10 + 3 ) x ( ( 20 x 5 ) + 10 ) ) "));
	}
